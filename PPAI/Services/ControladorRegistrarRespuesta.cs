...
namespace PPAI.Services
{
    public class ControladorRegistrarRespuesta
    {
        ...
        public void NuevaRtaOperador(int idLlamada, int idCategoria, PantallaRegistrarRespuesta pantalla)//polimorfismo
        {
            ...
            llamadaActual.TomadaPorOperador(DateTime.Now); //delegacion
